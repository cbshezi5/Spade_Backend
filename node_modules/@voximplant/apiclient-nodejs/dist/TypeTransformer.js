...
TypeTransformer.fromActors = {
    ...
    'SmsHistoryType': function (data) {
        const xData = {};
        if (typeof data['sms_id'] !== 'undefined')
            xData['smsId'] = TypeTransformer.to('number')(data['sms_id']);
        if (typeof data['source_number'] !== 'undefined')
...
TypeTransformer.toActors = {
    ...
    'AttachedPhoneInfo': function (data) {
        ...
        if (typeof data['requiredVerification'] !== 'undefined')
            xData['required_verification'] = TypeTransformer.from('string')(data['requiredVerification']);
    ...
    'SmsHistory': function (data) {
        const xData = {};
        if (typeof data['smsId'] !== 'undefined')
            xData['sms_id'] = TypeTransformer.from('number')(data['smsId']);
        if (typeof data['sourceNumber'] !== 'undefined')
